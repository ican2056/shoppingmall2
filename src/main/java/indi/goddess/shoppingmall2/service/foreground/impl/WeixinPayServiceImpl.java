...
import indi.goddess.shoppingmall2.service.foreground.WeixinPayService;
import indi.goddess.shoppingmall2.utils.pay.HttpClient;
...
public class WeixinPayServiceImpl implements WeixinPayService {
	...
	public Map createNative(String out_trade_no, String total_fee) {
		...
		try {
			...
			Map map=new HashMap<>();
			map.put("code_url", "http://www.baidu.com");//生成支付二维码的链接
